...
// sample code from the Chuck Norris Jokes API: https://api.chucknorris.io/jokes/random
// This assignment needs to implement a Facade pattern to simplify the process of fetching and parsing jokes from the API. The JokeClient class serves as the Facade, providing a simple method to get a random joke without exposing the underlying complexities of HTTP requests and JSON parsing.
